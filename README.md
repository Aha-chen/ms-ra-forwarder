...
1. 修改语音选择为单选框/radio，并且只过滤中文（暂时只有中文需求）
2. 去掉`生成阅读（legado）语音引擎链接`按钮，替换成下载音频按钮
3. 添加生成试听语音，点击页面`创建试听`，生成试听，页面悬浮在对应标签上播放对应试听语音
4. 语音名称显示中文，但是不保证中文准确

## 修改需求

1. 新加的功能主要是为了实现页面试听+下载，而非项目的原本功能
2. 修改的代码80%是用chatgpt写的，我对js代码没有太多了解
3. 主要是为了满足个人需求，个人最开始只是希望能达到[Baiyuetribe/paper2gui](https://github.com/Baiyuetribe/paper2gui)这个项目语音的80%功能并且免费就可以了，所以代码写得非常烂
## 部署
